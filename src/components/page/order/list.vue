    ...
    <div>
        <el-form ref="form" :model="form" label-width="80px" style="width:1220px;margin: 30px auto 50px;">
                ...
                <el-col :span="7">
                    <div class="grid-content bg-purple">
                        <el-form-item label="日期时间">
                            <el-col :span="3" style="padding-left: 0;padding-right: 0;width: 116px;">
                ...
                <el-col :span="7">
                    <div class="grid-content bg-purple">
                        <el-form-item label="订单状态">
                            <el-select v-model="form.region" placeholder="请选择" style="width:255px;">
            ...
            <el-row :gutter="20" style="width: 1220px; margin: 20px auto;">
                ...
                <el-col :span="5"  style="margin-left:400px;margin-right: 20px;">
                    <div class="grid-content bg-purple">
